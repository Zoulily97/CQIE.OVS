...
(function ($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function (options) {
        ...
        function newDatepickerHTML() {
            ...
            var table = jQuery('<table class="datepicker" cellpadding="0" cellspacing="0" style="background-color:lightblue;font-size:x-small;"></table>');
        ...
        function loadMonth(e, el, datepicker, chosendate) {
            ...
            for (var i = 0; i < numdays; i++) {
                ...
                if ((yr || ((!startDate && !startMonth) || ((i + 1 >= startDate && mo == startMonth) || mo > startMonth))) &&(yr + 1 < yrs || ((!endDate && !endMonth) || ((i + 1 <= endDate && mo == endMonth) || mo < endMonth)))) {
                    cell.text(i + 1).addClass('date').hover(function () { jQuery(this).addClass('over'); },function () { jQuery(this).removeClass('over'); }).click(function () {
